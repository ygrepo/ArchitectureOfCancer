...
title_txt <- "Breast Cancer, BRCA1, Polyphen Score vs. -LOG10(PValue)"
alpha <- 1
pt <- get_polyphen_score_genebass_pvalue(df = df_cancer,
                                          title_txt,
                                          alpha = alpha,
                                          title_font_size = 24,
                                          x_y_font_size = 24,
...
filename <- "20240519_BreastCancer_BRCA1_Polyphen_LOG10PVal.jpg"
save_plot(
  filename = filename,
  pt = pt
)
